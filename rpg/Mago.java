...
public class Mago extends Personagem {
    ...
    public Mago(String nome, int vida, int ataque, int defesa, int mana, int poderMagico) {
        ...
        this.acoes.add(new AcaoBolaDeFogo());
        this.acoes.add(new AcaoUsarPocao());
    }
    ...
    public void atacar(Personagem alvo) throws ManaInsuficienteException {
        ...
        mana -= 5;
        System.out.println(nome + " lança magia em " + alvo.getNome() + " causando " + dano
                + " de dano! (Mana: " + mana + ")");
    }

public void bolaDeFogo(Personagem alvo) throws ManaInsuficienteException {
    if (mana < 10)
        throw new ManaInsuficienteException("Mana insuficiente para Bola de Fogo!");
    int dano = poderMagico + Dado.rolar(12) - alvo.getDefesa();
    if (dano < 0)
        dano = 0;
    alvo.receberDano(dano);
    mana -= 10;
System.out.println(nome + " lança Bola de Fogo em " + alvo.getNome() + " causando "
+ dano + " de dano! (Mana: " + mana + ")");
}
